...
async function main() {
  ...
  // Create admin user
  const adminPassword = await bcryptjs.hash(process.env.ADMIN_PASSWORD || 'demo123', 10);
  ...
  const customerPassword = await bcryptjs.hash(process.env.CUSTOMER_PASSWORD || 'demo123', 10);
